; afficher la chaine adn avec coloration des chaines contigue inverse avec affichage des tirets
...
Code segment
 ...
 main:            ;  debut de notre programe 
    ...
    boucleADN:       ; pour traiter toute les sous chaine de adn 
	    ...
	    mov dl,[si] ; dans ce cas [si]=="-" donc il faut l'afficher
        mov ah,2h
        int 21H
	    ;  les trois instruction precedentes servent a afficher le tiret dans ce cas car il reste d'autres sous chaine a traiter 
